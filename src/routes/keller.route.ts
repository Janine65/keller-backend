...
export class KellerRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(this.path + '/things/alcoholic/subplaces/update', AuthMiddleware, this.thing.updateAlcoholic2Subplaces)
    this.router.delete(this.path + '/things/alcoholic/subplaces/delete', AuthMiddleware, this.thing.deleteAlcoholic2Subplaces)
    ...
    this.router.post(this.path + '/things/food/subplaces/update', AuthMiddleware, this.thing.updateFood2Subplaces)
    this.router.delete(this.path + '/things/food/subplaces/delete', AuthMiddleware, this.thing.deleteFood2Subplaces)
    ...
    this.router.post(this.path + '/things/nonalcoholic/subplaces/update', AuthMiddleware, this.thing.updateNonalcoholic2Subplaces)
    this.router.delete(this.path + '/things/nonalcoholic/subplaces/delete', AuthMiddleware, this.thing.deleteNonalcoholic2Subplaces)
    ...
    this.router.post(this.path + '/things/nonfood/subplaces/update', AuthMiddleware, this.thing.updateNonfood2Subplaces)
    this.router.delete(this.path + '/things/nonfood/subplaces/delete', AuthMiddleware, this.thing.deleteNonfood2Subplaces)
  }
}
